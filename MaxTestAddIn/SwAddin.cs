...
{
    /// <summary>
    /// Summary description for MaxTestAddIn.
    /// </summary>
    [Guid("175fc051-47ae-446a-9b43-3af101538b9f"), ComVisible(true)]
    [SwAddin(
        Description = "MaxTestAddIn description",
        Title = "MaxTestAddIn",
        LoadAtStartup = true
        )]
    public class SwAddin : ISwAddin
    {
        ...
        public const int mainItemID4 = 3; // 221125 Added variable for macro feature
        ...
        public MFPMP mfpage = null; // 221125 PMP for macro feature
        #endregion
        ...
        public void AddCommandMgr()
        {
            ...
            int cmdIndex0, cmdIndex1, cmdIndex2; // 221125 added variable for cmdindex2
            ...
            int[] knownIDs = new int[3] { mainItemID1, mainItemID2, mainItemID4 }; // 221125 Added mainItemID4
            ...
            icons[0] = iBmp.CreateFileFromResourceBitmap("MaxTestAddIn.toolbar20x.png", thisAssembly);
            icons[1] = iBmp.CreateFileFromResourceBitmap("MaxTestAddIn.toolbar32x.png", thisAssembly);
            icons[2] = iBmp.CreateFileFromResourceBitmap("MaxTestAddIn.toolbar40x.png", thisAssembly);
            icons[3] = iBmp.CreateFileFromResourceBitmap("MaxTestAddIn.toolbar64x.png", thisAssembly);
            icons[4] = iBmp.CreateFileFromResourceBitmap("MaxTestAddIn.toolbar96x.png", thisAssembly);
            icons[5] = iBmp.CreateFileFromResourceBitmap("MaxTestAddIn.toolbar128x.png", thisAssembly);

            mainIcons[0] = iBmp.CreateFileFromResourceBitmap("MaxTestAddIn.mainicon_20.png", thisAssembly);
            mainIcons[1] = iBmp.CreateFileFromResourceBitmap("MaxTestAddIn.mainicon_32.png", thisAssembly);
            mainIcons[2] = iBmp.CreateFileFromResourceBitmap("MaxTestAddIn.mainicon_40.png", thisAssembly);
            mainIcons[3] = iBmp.CreateFileFromResourceBitmap("MaxTestAddIn.mainicon_64.png", thisAssembly);
            mainIcons[4] = iBmp.CreateFileFromResourceBitmap("MaxTestAddIn.mainicon_96.png", thisAssembly);
            mainIcons[5] = iBmp.CreateFileFromResourceBitmap("MaxTestAddIn.mainicon_128.png", thisAssembly);
            ...
            // 221125 Add Command item for macro feature with ability to store face selection
            cmdIndex2 = cmdGroup.AddCommandItem2("CreateMacroFeature", -1, "Create a Macro Feature", "Create Macro Feature", 0, "CreateMacroFeature", "EnableMFPMP" , mainItemID4, menuToolbarOption);
        ...
        // 221125 function to create macro feature
