...
namespace MaxTestAddIn
{
    public class MFPMP
    {
        ...
        //Groups
        public IPropertyManagerPageGroup group1;
        public IPropertyManagerPageGroup group2;
        ...
        public IPropertyManagerPageSelectionbox selection1;
        ...
        protected void CreatePropertyManagerPage()
        {
            ...
            handler = new MFPMPHandler(userAddin, this);
